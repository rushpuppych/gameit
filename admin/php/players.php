...
echo '[![](http://localhost:8888/gi/img.php?img=0-0&player=' . $strUid . ')](http://localhost:8888/gi/screen.php?src=ext&img=score&player=' . $strUid . ")\n";
echo '[![](http://localhost:8888/gi/img.php?img=1-0&player=' . $strUid . ')](http://localhost:8888/gi/screen.php?src=ext&img=score&player=' . $strUid . ")\n";
echo '[![](http://localhost:8888/gi/img.php?img=2-0&player=' . $strUid . ')](http://localhost:8888/gi/screen.php?src=ext&img=score&player=' . $strUid . ")\n";
echo '                </textarea>';
echo '            </div>';
echo '        </form>';
echo '    </div>';
