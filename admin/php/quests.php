...
echo "![](http://138.197.90.62/gi/img.php?img=0-0&quest=" . $strUid . ")\n";
echo "[![](http://138.197.90.62/gi/img.php?img=1-0&quest=" . $strUid . ")](http://138.197.90.62/gi/quest.php?src=ext&quest=" . $strUid . ")\n";
echo '                </textarea>';
echo '            </div>';
echo '        </form>';
echo '    </div>';
